...
#SOAL BAGIAN A
    ...
    if not((data['kode_negara'] == country_code).any()) :
        ...
        with st.expander('Klik untuk melihat Grafik negara '+ opsi_negara +' ' + ':'+opsi_negara+':'):
            
            data_produksi = data.loc[data["kode_negara"] == country_code]
            
            chart_a = px.line(data_produksi, x = "tahun", y = "produksi", 
                                labels={'tahun' : 'Tahun', 'produksi' : 'Jumlah Produksi', 
                                'kode_negara' : 'Kode Negara'}, hover_data=['kode_negara'],
                                title='Grafik Produksi Minyak Mentah {negara}'.format(negara=opsi_negara),
                                template="seaborn")
...
# SOAL BAGIAN B
    ...
    with st.expander('Klik untuk melihat Grafik  negara dengan jumlah produksi terbesar pada tahun '+ str(opsi_tahun)):
        chart_b = px.line(besar_data, x = "kode_negara", y = "produksi", labels={'tahun' : 'Tahun', 'produksi' : 'Jumlah Produksi', 'kode_negara' : 'Kode Negara'}, hover_data=['kode_negara'], title=judul_b, template="seaborn")
...
# SOAL BAGIAN C
    ...
    with st.expander("Klik untuk melihat grafik produksi terbesar secara kumulatif tahun"):
        chart_c = px.line(data_kumulatif, x = "kode_negara", y = "kumulatif", 
                        labels={'kumulatif' : 'Jumlah Kumulatif', 'produksi' : 'Jumlah Produksi', 
                        'kode_negara' : 'Kode Negara'}, title="Grafik {jumlahngr} Buah Negara dengan Jumlah Kumulatif Produksi Terbesar".format(jumlahngr = option_jumlah), template="seaborn")
        st.plotly_chart(chart_c, use_container_width=True)
